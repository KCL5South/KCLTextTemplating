...
namespace Mono.TextTemplating.Utility.EntityFramework
{
    ...
    public class DynamicHost : IDynamicHost
    {
        ...
        {
            _instance = instance;
            Type type = instance is Microsoft.VisualStudio.TextTemplating.ITextTemplatingEngineHost ? typeof(Microsoft.VisualStudio.TextTemplating.ITextTemplatingEngineHost) : _instance.GetType();
